...
public:
	...
	static Singleton* GetInstance()
	{
		...
		// }
		// return instacne_;
		//get()方法返回原生指针，但没有释放所有权，release()方法会释放所有权
		if (!instacne_.get()))
		{
			instacne_ = auto_ptr<Singleton>(new Singleton);//智能指针的所有权转移给了instacne_，instacne_持有了new Singleton所分配的内存资源
		}
...
shared_ptr<Singleton> Singleton::instacne_;
