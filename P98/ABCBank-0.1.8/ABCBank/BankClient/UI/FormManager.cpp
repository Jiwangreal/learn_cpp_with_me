...
FormManager::FormManager()
{
	...
	forms_["QueryHistoryBillForm"] = new QueryHistoryBillForm(13, 5, 54, 13);//依据时间范围的查询界面
	forms_["QueryAccountHistoryBillForm"] = new QueryAccountHistoryBillForm(13, 5, 54, 15);//依据账号的查询界面
}
